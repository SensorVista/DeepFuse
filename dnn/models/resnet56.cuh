...
public:
    explicit ResNet56(int num_classes = 10, T lr = 0.1, T momentum = 0.9, bool training_enabled = false)
          ...
          fc_(16 * 4, num_classes, training_enabled)
    {
        ...
        // Stage 3: 1 downsample block (2C, 4C, 2), then 8 (4C, 4C, 1)
    ...
    static std::unique_ptr<ResNet56<T>> load(const std::string& path, bool training_enabled);
